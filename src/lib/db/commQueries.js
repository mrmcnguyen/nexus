...
export async function sendInvite(a_sender_id, a_custom_message, a_recipient_email, a_project_id, a_recipient_id){

    console.log(a_sender_id, a_custom_message, a_recipient_email, a_project_id);

    const { data, error } = await supabase
    .from('invitations')
    .insert({ sender_id: a_sender_id, status: 'PENDING', recipient_email: a_recipient_email, project_id: a_project_id, custom_message: a_custom_message, recipient_id: a_recipient_id });
